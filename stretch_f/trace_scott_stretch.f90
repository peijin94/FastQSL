...
use field_common
implicit none
real::  vector9(0:8), vector9_k(0:8), grad_unit_vec_B(0:2,0:2), vp(0:2), bp(0:2), unit_vec_bp(0:2), weight(0:1,0:1,0:1)
...
dt, ds, alpha, ds_factor, unit_vec_bp(0:2), vp(0:2), vp1(0:2)
logical:: alphaFlag
...
if (uni_strech_Flag) then
	call vp_index_uni_strech(vp, vp1, index_i, index_j, index_k)
else
	call vp_index(vp, vp1, index_i, index_j, index_k)
endif
ds_factor=norm2(k1(0:2)/[dxa(index_i),dya(index_j),dza(index_k)])
ds=dt/ds_factor
...
real:: dt, ds, ds0, ds1, error, min_error, unit_vec_bp(0:2), ds_factor, vp0(0:2), vp1(0:2)
...
use trace_common
implicit none
real:: dt, ds0, ds1, vp(0:2), vp0(0:2), vp1(0:2)
